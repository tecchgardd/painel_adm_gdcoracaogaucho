...
export function ApiRecordScreen({
  ...
  return (
    <Screen variant="admin">
      ...
      {!loading && !error && !filtered.length ? <EmptyState title={`Nenhum ${singular.toLowerCase()} encontrado.`} /> : null}
...
const styles = StyleSheet.create({
  ...
  rowCard: { flex: 1 },
  sheetHeader: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', marginBottom: 10 },
